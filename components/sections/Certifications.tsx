...
const certifications = [
  ...
  },
  {
    ...
    issuedDate: 'Mar 2026',
    description: 'Craft out an effective research plan to tackle human-centred problems',
    Icon: Sparkles,
    category: 'experience',
  },
  {
  ...
  },
  {
    ...
    issuedDate: 'Mar 2026',
    description: 'Mastered basic management of Linux from the command line, including file management, operating system management and security.',
    Icon: Bot,
    category: 'programming',
  },
    {
  ...
  },
  {
    ...
    issuedDate: 'Sep 2024',
    description: 'Completed Python programming fundamentals course covering core concepts and applications.',
    Icon: Code,
    category: 'programming',
  },
     {
