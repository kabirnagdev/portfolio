...
const TechIcons: Record<string, () => JSX.Element> = {
  ...
  'Pandas': () => (
    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
      <path d="M8.572 0c-.44 0-.797.353-.797.79v5.51c0 .436.356.79.797.79h.796V9.1h-.796c-.44 0-.797.354-.797.79v5.512c0 .437.356.79.797.79h.796v1.677h1.592v-1.677h.796c.44 0 .797-.353.797-.79V9.89c0-.436-.356-.79-.797-.79h-.796V7.09h.796c.44 0 .797-.354.797-.79V.79c0-.437-.356-.79-.797-.79H8.572zm.797 1.58h.796v4.72H9.37V1.58zm0 8.309h.796v4.72H9.37V9.89zM14.24 0c-.44 0-.797.353-.797.79v5.51c0 .436.356.79.797.79h.796V9.1h-.796c-.44 0-.797.354-.797.79v5.512c0 .437.356.79.797.79h.796v1.677h1.592v-1.677h.796c.44 0 .797-.353.797-.79V9.89c0-.436-.356-.79-.797-.79h-.796V7.09h.796c.44 0 .797-.354.797-.79V.79c0-.437-.356-.79-.797-.79H14.24zm.797 1.58h.796v4.72h-.796V1.58zm0 8.309h.796v4.72h-.796V9.89z"/>
    </svg>
  ),
  'Matplotlib / Seaborn': () => (
    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
      <path d="M3.5 18.49l6-6.01 4 4L22 6.92l-1.41-1.41-7.09 7.97-4-4L2 16.99zM2 20h20v2H2v-2z"/>
    </svg>
  ),
  'Scikit-learn': () => (
    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
      <path d="M12 2l2.4 5 5.6.8-4 4 .9 5.5L12 14.5l-4.9 2.8.9-5.5-4-4 5.6-.8L12 2zm0 3.2l-1.6 3.3-3.6.5 2.6 2.6-.6 3.6 3.2-1.8 3.2 1.8-.6-3.6 2.6-2.6-3.6-.5L12 5.2z"/>
    </svg>
  ),
  'TensorFlow / Keras': () => (
    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
      <path d="M1.292 5.856L11.54 0v24l-4.095-2.378V7.603l-6.168 3.564.015-5.311zm21.43 5.311l-6.168-3.564v14.019L12.46 24V0l10.262 5.856v5.311z"/>
    </svg>
  ),
  'ANN': () => (
    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
      <path d="M12 2a2 2 0 110 4 2 2 0 010-4zM4 10a2 2 0 110 4 2 2 0 010-4zm16 0a2 2 0 110 4 2 2 0 010-4zM8 18a2 2 0 110 4 2 2 0 010-4zm8 0a2 2 0 110 4 2 2 0 010-4zM10.5 5.5L5.5 10.8M13.5 5.5L18.5 10.8M9.5 17.2L6 13.8M14.5 17.2L18 13.8M10.5 12H6M13.5 12H18"/>
    </svg>
  ),
  'CNN': () => (
    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
      <path d="M2 3h5v5H2V3zm7 0h5v5H9V3zm7 0h5v5h-5V3zM2 10h5v5H2v-5zm7 0h5v5H9v-5zm7 0h5v5h-5v-5zM6 18h12v3H6v-3z"/>
    </svg>
  ),
  'Encoders': () => (
    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
      <path d="M4 4h6v6H4V4zm10 0h6v6h-6V4zM4 14h6v6H4v-6zm10 0h6v6h-6v-6zm-3-8h2v12h-2V6z"/>
    </svg>
  ),
  'NLP': () => (
    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
      <path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12zM7 9h10v2H7V9zm0-3h10v2H7V6zm0 6h7v2H7v-2z"/>
    </svg>
  ),
  'Data Preprocessing': () => (
    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
  ...
  'Jupyter / Colab': () => (
    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
      <path d="M7.157 22.201A1.784 1.784 0 015.374 24a1.784 1.784 0 01-1.784-1.799 1.784 1.784 0 011.784-1.784 1.784 1.784 0 011.783 1.784zM20.096 23.85a1.135 1.135 0 01-1.135 1.135 1.135 1.135 0 01-1.135-1.135 1.135 1.135 0 011.135-1.136 1.135 1.135 0 011.135 1.136zM23.852 20.936a.724.724 0 01-.725.724.724.724 0 01-.724-.724.724.724 0 01.724-.725.724.724 0 01.725.725zM3.08 19.001a1.9 1.9 0 00-1.896 1.878A1.9 1.9 0 003.08 22.758a1.9 1.9 0 001.896-1.879A1.9 1.9 0 003.08 19zm4.604-8.708c0 4.042-2.677 7.466-6.476 8.56A9.5 9.5 0 010 12 9.5 9.5 0 019.5 2.5a9.5 9.5 0 01.87.04C10.027 3.188 9.844 3.894 9.844 4.64c0 1.68.72 3.19 1.87 4.245l.23-.044a1.89 1.89 0 01-.258.952zm2.27 7.304a9.5 9.5 0 002.478 1.685 9.5 9.5 0 01-2.478-1.685zm3.396.58a9.5 9.5 0 002.476-1.68 9.5 9.5 0 01-2.476 1.68zm5.874-8.977c.137.77.207 1.563.207 2.375a9.5 9.5 0 01-6.476 8.56 9.5 9.5 0 006.476-8.56c0-.812-.07-1.605-.207-2.375z"/>
    </svg>
  ),
  'MATLAB': () => (
    <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
